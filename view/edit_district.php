...
if (!empty($_GET['id']) ) {
    ...
    $sql = $db->query("SELECT * FROM `districts` WHERE `id` = '$id'  limit 1 " );
    $row = $sql->fetch();
}else {
                            ...
                            <form id="validation-form" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="action_district.php">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-9 col-lg-offset-3">
                                        ...
                                        <a href="list_district.php" class="btn btn-danger w-md m-b-5 bfont"> &nbsp; <i class="fa fa-arrow-left"> </i> لغو ویرایش </a>
                                    </div>
                                </div>
                            </form>
                        </div>
